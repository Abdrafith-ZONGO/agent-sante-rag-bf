...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "")  # Conservé pour compatibilité mais non utilisé
EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2"  # Embeddings locaux, sans API
# --- Paramètres RAG ---
CHUNK_SIZE = 800
CHUNK_OVERLAP = 120
TOP_K_RESULTS = 3
